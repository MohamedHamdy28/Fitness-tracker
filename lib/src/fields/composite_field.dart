...
class SQCompositeField extends SQField<Map<String, dynamic>> {
  ...
  @override
  formField(docScreen) => SQCompositeFormField(this, docScreen);

  @override
  String toString() => 'my hamada';
}

class SQCompositeFormField
    extends SQFormField<Map<String, dynamic>, SQCompositeField> {
  SQCompositeFormField(super.field, super.docScreen) {
